...
| lambda | nil | (custom-set-faces '(default ((t (:font Comic Code Ligatures-12 (, :slant) 'italic)))) '(fixed-pitch ((t (:inherit (default))))) '(fixed-pitch-serif ((t (:inherit (default))))) '(variable-pitch ((t (:font Fira Code-10))))) |
| lambda | nil | (custom-set-faces '(default ((t (:font Comic Code Ligatures-14 (, :slant) 'italic)))) '(fixed-pitch ((t (:inherit (default))))) '(fixed-pitch-serif ((t (:inherit (default))))) '(variable-pitch ((t (:font Fira Code-10))))) |
